...
function DeckStack() {
  return (
    <DeckStackNav.Navigator screenOptions={screenOptions}>
      <DeckStackNav.Screen name="Decks" component={DeckList} options={{ headerTitleStyle: { color: '#6366f1', fontWeight: '800', fontSize: 22 } }} />
...
function ConversationsStack() {
  return (
    <ConvoStackNav.Navigator screenOptions={screenOptions}>
      <ConvoStackNav.Screen name="Categories" component={ConversationCategories} options={{ title: 'Conversation Categories' }} />
...
export default function App() {
  ...
  useEffect(() => {
    ...
    Promise.all([loadProgress(), loadLanguage(), hydrate(), minDelay]).then(() =>
      setReady(true),
    );

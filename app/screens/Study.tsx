        ...
        <GestureDetector gesture={pan}>
          <Animated.View style={[st.cardOuter, { width: cardW, height: cardH }, cardAnim]}>
            <Pressable onPress={toggleFlip} style={st.cardPressable}>
              {/* Front face */}
              {img ? (
                <Animated.View style={[st.cardFace, { borderColor: theme.border, borderWidth: 3 }, frontStyle]}>
                  <Image source={img} style={st.imgFill} resizeMode="cover" />
                  <LinearGradient
